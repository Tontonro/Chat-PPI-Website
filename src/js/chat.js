...
const CHATS = {
  "sala-geral": {
    ...
    messages: [
      ...withRandomTimes([
        { user: "Nyx",        text: "Bora bill" },
        { user: "Tontoro",    text: "Deixe de frescura, macho" },
        { user: "Udibone",    text: "fala aí, rapaziada, o que há de novo?" },
        { user: "Tontoro",    text: "Nyx tá me devendo 2 reais" },
        { user: "Nyx",        text: "mentira" },
        { user: "Tontoro",    text: "me pague logo, cuide" },
        { user: "Udibone",    text: "pague o rapaz" },
        { user: "Nyx",        text: "🫡" },
      ], 8, 8),
    ],
  },
